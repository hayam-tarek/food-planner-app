...
//                }
//            } catch (e: Exception) {
//                Log.i("HomeViewModel", "getRandomMeal: ${e.message}")
//            }
//        }
//    }
//
...
//                    } else {
//                        _isFavorite.value = checkIfFavorite(meal.meals[0], dao, _uid)
//                        _mealDetails.postValue(meal)
//                    }
//                }
//            } catch (e: Exception) {
//                Log.i("HomeViewModel", "getMealDetails: ${e.message}")
//            }
//        }
//    }
//
...
//                }
//            } catch (e: Exception) {
//                Log.i("HomeViewModel", "getAreas: ${e.message}")
//            }
//        }
//    }
//
...
//                }
//            } catch (e: Exception) {
//                Log.i("HomeViewModel", "getCategories: ${e.message}")
//            }
//        }
//    }
//
...
//                }
//            } catch (e: Exception) {
//                Log.i("HomeViewModel", "getIngredients: ${e.message}")
//            }
//        }
//    }
//}