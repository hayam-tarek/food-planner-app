    ...
    fun getFavorites() {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                Log.e("FavoritesViewModel", "getFavorites: ${e.message}")
            }
        }
    }
    ...
    fun getFavoriteMealById(mealId: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                Log.e("FavoritesViewModel", "getFavoriteMealById: ${e.message}")
            }
        }
    }
    ...
    fun toggleFavorite(meal: Meal) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                Log.e("FavoritesViewModel", "toggleFavorite: ${e.message}")
            }
        }
    }
}